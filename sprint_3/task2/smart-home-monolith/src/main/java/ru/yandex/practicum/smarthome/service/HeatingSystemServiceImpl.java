...
import ru.yandex.practicum.smarthome.adapter.ActionMessageAdapter;
...
public class HeatingSystemServiceImpl implements HeatingSystemService {
    ...
    private final ActionMessageAdapter actionMessageAdapter;
    @Override
    ...
    public void turnOn(Long id) {
        ...
        actionMessageAdapter.publishAction(heatingSystem);
    }
